...
const BlogArticle = () => {
  ...
  return (
    ...
    <section className="py-12 md:py-16 container-custom max-w-4xl mx-auto px-4 sm:px-6">
      ...
      <article className="bg-white card-glass border-2 border-neutral-300 rounded-[2rem] shadow-md p-6 sm:p-12 overflow-hidden relative" style={{ isolation: 'isolate' }}>
        ...
        <FlakPink className="absolute pointer-events-none" style={{ width: 180, bottom: 10, left: '35%', opacity: 0.30, zIndex: -1, transform: 'rotate(-30deg)' }} />
        {/* Label Badge */}
        {label && (
          <span
