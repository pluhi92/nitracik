...
import { ArrowLeft, ChevronUp, UserCheck } from 'lucide-react';
  ...
  return (
    <div className="relative w-full bg-white">
      ...
      <div className="bg-white card-glass border-2 border-neutral-300 rounded-[2rem] shadow-md p-8 sm:p-12 md:p-16 relative overflow-hidden" style={{ isolation: 'isolate' }}>
        <FlakCream className="absolute pointer-events-none" style={{ width: 185, top: 10, left: '35%', opacity: 0.32, zIndex: -1, transform: 'rotate(-20deg)' }} />
        <FlakPink className="absolute pointer-events-none" style={{ width: 180, bottom: 10, right: -20, opacity: 0.35, zIndex: -1, transform: 'rotate(35deg)' }} />
        ...
        <div className="space-y-8 text-neutral-600 leading-relaxed font-medium text-justify">
            ...
            <div className="overflow-x-auto rounded-xl border border-neutral-200 shadow-sm">
              <table className="min-w-full border-collapse text-sm">
                ...
                <tbody className="divide-y divide-neutral-200">
                  <tr>
                    <td className="border-r border-neutral-200 px-4 py-3 align-top">1. Fyzická osoba, ktorá sa zaregistrovala</td>
                    <td className="border-r border-neutral-200 px-4 py-3 align-top">
                      <strong className="text-foreground">AGENDA REGISTRÁCIE</strong><br/>
                    ...
                    <td className="border-r border-neutral-200 px-4 py-3 align-top">čl. 6 ods. 1 písm. b) Nariadenia - ZMLUVNÉ A PREDZMLUVNÉ VZŤAHY – bezodplatná zmluva</td>
                    <td className="border-r border-neutral-200 px-4 py-3 align-top">3 roky od posledného prihlásenia sa do konta, alebo zrušením konta samotnou registrovanou osobou, podľa toho čo nastane skôr</td>
                  ...
                  <tr>
                    <td className="border-r border-neutral-200 px-4 py-3 align-top">2. Fyzická osoba, ktorá si zakúpila tovar alebo službu</td>
                    <td className="border-r border-neutral-200 px-4 py-3 align-top">
                      <strong className="text-foreground">AGENDA UZATVORENIA KÚPNEJ ZMLUVY</strong><br/>
                      Účelom spracúvania OÚ je uzatvorenie a plnenie kúpnej zmluvy v súvislosti s nákupom na stránke www.nitracik.sk
                    </td>
                    <td className="border-r border-neutral-200 px-4 py-3 align-top">čl. 6 ods. 1 písm. b) Nariadenia - ZMLUVNÉ A PREDZMLUVNÉ VZŤAHY – kúpna zmluva</td>
                    <td className="border-r border-neutral-200 px-4 py-3 align-top">10 rokov nasledujúcich po roku ktorého sa týkajú</td>
                    <td className="px-4 py-3 align-top">kuriérske spoločnosti, a iné subjekty, ktorým prevádzkovateľ poskytuje OÚ na základe zákona, odborní konzultanti a poradcovia, ktorí sú viazaní zákonnou a/alebo zmluvnou povinnosťou mlčanlivosti, spoločnosť Google poskytujúca dátové úložisko Google Disk, Google email a ďalšie nástroje Google Workspace služby; spoločnosť poskytujúca</td>
                  </tr>
                  <tr>
                    <td className="border-r border-neutral-200 px-4 py-3 align-top">3. Fyzická osoba, ktorá si zakúpila tovar alebo službu</td>
                    <td className="border-r border-neutral-200 px-4 py-3 align-top">
                      <strong className="text-foreground">AGENDA ÚČTOVNÍCTVA</strong><br/>
                    ...
                    <td className="border-r border-neutral-200 px-4 py-3 align-top">čl. 6 ods. 1 písm. c) Nariadenia - nevyhnutné na splnenie ZÁKONNÝCH POVINNOSTÍ prevádzkovateľa vyplývajúcich zo zák. č. 431/2002 Z. z., zák. č. 222/2004 Z. z., zák. č. 40/1964 Zb., zák. č. 311/2001 Z. z., zák. č. 595/2003 Z. z., zák. č. 582/2004 Z. z., zák. č. 283/2002 Z. z. a súvisiacich právnych predpisov</td>
                    <td className="border-r border-neutral-200 px-4 py-3 align-top">10 rokov nasledujúcich po roku ktorého sa týkajú</td>
                    <td className="px-4 py-3 align-top">prevádzkovatelia platobných brán a iné subjekty, ktorým prevádzkovateľ poskytuje OÚ na základe zákona, odborní konzultanti a poradcovia, ktorí sú viazaní zákonnou a/alebo zmluvnou povinnosťou mlčanlivosti, spoločnosť poskytujúca účtovné služby; spoločnosť Google poskytujúca dátové úložisko Google Disk, Google email a ďalšie nástroje Google Workspace služby; spoločnosť poskytujúca</td>
                  </tr>
                  <tr>
                    <td className="border-r border-neutral-200 px-4 py-3 align-top">4. Fyzická osoba, ktorá si zakúpila tovar alebo službu a nenamietla voči zasielaniu marketingových informácií</td>
                    <td className="border-r border-neutral-200 px-4 py-3 align-top">
                      <strong className="text-foreground">AGENDA MARKETINGU E-SHOP</strong><br/>
                    ...
                    <td className="border-r border-neutral-200 px-4 py-3 align-top">čl. 6 ods. 1 písm. f) Nariadenia - OPRÁVNENÝ ZÁUJEM. Oprávneným záujmom prevádzkovateľa je zasielanie newslettrov dotknutým osobám, ktoré obsahujú marketingové informácie týkajúce sa vlastných a podobných tovarov a služieb, ako bol kúpený tovar/služba, s cieľom informovania o novinkách, aktivitách, možnostiach na www.nitracik.sk a iných skutočnostiach súvisiacich s kúpou tovarov alebo služieb na www.nitracik.sk na základe § 116 ods. 15 zákona č. 452/2021 Z.z. o elektronických komunikáciách</td>
                    <td className="border-r border-neutral-200 px-4 py-3 align-top">1 rok od vykonania posledného nákupu</td>
                    <td className="px-4 py-3 align-top">subjekty, ktorým prevádzkovateľ poskytuje OÚ na základe zákona, odborní konzultanti a poradcovia, ktorí sú viazaní zákonnou a/alebo zmluvnou povinnosťou mlčanlivosti, spoločnosť Google poskytujúca dátové úložisko Google Disk, Google email a ďalšie nástroje Google Workspace služby;</td>
                  </tr>
                  <tr>
                    <td className="border-r border-neutral-200 px-4 py-3 align-top">5. Reklamujúca osoba</td>
                    <td className="border-r border-neutral-200 px-4 py-3 align-top">
                      <strong className="text-foreground">AGENDA REKLAMÁCIÍ</strong><br/>
                      Účelom spracúvania OÚ je vedenie agendy reklamácií.
                    </td>
                    <td className="border-r border-neutral-200 px-4 py-3 align-top">čl. 6 ods. 1 písm. c) Nariadenia - nevyhnutné na splnenie ZÁKONNÝCH POVINNOSTÍ prevádzkovateľa vyplývajúcich zo zák. č. 108/2024 Z. z.</td>
                    <td className="border-r border-neutral-200 px-4 py-3 align-top">10 rokov po ukončení reklamácie</td>
                    <td className="px-4 py-3 align-top">Slovenská obchodná inšpekcia a iné subjekty, ktorým prevádzkovateľ poskytuje OÚ na základe zákona, odborní konzultanti a poradcovia ktorí sú viazaní zákonnou a/alebo zmluvnou povinnosťou mlčanlivosti, spoločnosť Google poskytujúca dátové úložisko Google Disk, Google email a ďalšie nástroje Google Workspace služby; spoločnosť poskytujúca</td>
                  </tr>
                  <tr>
                    <td className="border-r border-neutral-200 px-4 py-3 align-top">6. fyzické osoby uplatňujúce svoje práva ako dotknuté osoby</td>
                    <td className="border-r border-neutral-200 px-4 py-3 align-top">
                    ...
                    <td className="border-r border-neutral-200 px-4 py-3 align-top">spracúvanie je v zmysle čl. 6 ods. 1 písm. c) Nariadenia nevyhnutné na splnenie zákonnej povinnosti prevádzkovateľa vyplývajúcej z nariadenia a zo zákona č. 18/2018 Z. z.</td>
                  ...
                  <tr>
                    <td className="border-r border-neutral-200 px-4 py-3 align-top">7. Strany sporu, účastníci konania a ďalšie zúčastnené osoby</td>
                    <td className="border-r border-neutral-200 px-4 py-3 align-top">
                    ...
                    <td className="border-r border-neutral-200 px-4 py-3 align-top">čl. 6 ods. 1 písm. c) Nariadenia - nevyhnutné na splnenie ZÁKONNÝCH POVINNOSTÍ prevádzkovateľa vyplývajúcich zo zák. č. 160/2015 Z. z., zák. č. 244/2002 Z. z., zák. č. 301/2005 Z. z., zák. č. 7/2005 Z. z., zák. č. 38/1993 Z. z., zák. č. 162/2015 Z. z., zák. č. 233/1995 Z. z. a súvisiacich právnych predpisov</td>
                    <td className="border-r border-neutral-200 px-4 py-3 align-top">10 rokov po právoplatnom skočení príslušného konania</td>
                    <td className="px-4 py-3 align-top">súdy, exekútori, advokáti a iné orgány verejnej správy a subjekty, ktorým Prevádzkovateľ poskytuje OÚ na základe zákona, spoločnosť zabezpečujúca skartáciu a archiváciu, odborní konzultanti a poradcovia ktorí sú viazaní zákonnou a/alebo zmluvnou povinnosťou mlčanlivosti</td>
                  </tr>
                </tbody>
              </table>
            </div>
          ...
          <section>
            ...
            <p className="mt-3">
              <strong className="text-foreground">Kategória OÚ, ktoré nemá prevádzkovateľ priamo od dotknutej osoby:</strong> dátum a čas registrácie, dátum a čas posledného prihlásenia sa do konta, dátum a čas vytvorenia objednávky, obsah objednávky, informácia o námietke voči zasielaniu vlastných a podobných tovaroch a službách, informácie o rezervácií, evidencii platieb, kreditov, permanentiek.
            </p>
          </section>
          ...
          <section>
            <p>
              ...
              <a href="mailto:gdpr@nitracik.sk" className="text-primary font-bold hover:underline">gdpr@nitracik.sk</a>. Zároveň máte možnosť obrátiť sa so sťažnosťou na Úrad na ochranu osobných údajov Slovenskej republiky, so sídlom Námestie 1. mája 18, 811 06 Bratislava, budova Park One, e-mail:{' '}
