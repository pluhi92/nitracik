  ...
  return (
    <div className="relative w-full min-h-screen bg-white">
      ...
      <div className="bg-white rounded-[2rem] shadow-md border-2 border-neutral-300 p-8 sm:p-12 relative overflow-hidden">
        <FlakCream className="absolute pointer-events-none z-0" style={{ width: 185, top: 10, left: -20, opacity: 0.32, transform: 'rotate(-20deg)' }} />
        <FlakPink className="absolute pointer-events-none z-0" style={{ width: 170, bottom: 10, right: -18, opacity: 0.35, transform: 'rotate(30deg)' }} />
