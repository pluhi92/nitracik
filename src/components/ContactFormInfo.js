      ...
      {showScrollButton && (
        ...
        >
          ...
          <section>
            <div className="overflow-x-auto">
              <table className="min-w-full border-collapse border border-gray-300 text-sm">
                ...
                <tbody>
                  <tr>
                    <td className="border border-gray-300 px-4 py-2">1. Fyzická osoba, ktorá oslovila prevádzkovateľa prostredníctvom online formulára</td>
                    <td className="border border-gray-300 px-4 py-2">
                      <strong>AGENDA KONTAKTNÝ FORMULÁR</strong><br/>
                    ...
                    <td className="border border-gray-300 px-4 py-2">6 mesiacov odo dňa vybavenia požiadavky</td>
                  ...
                  <tr>
                    <td className="border border-gray-300 px-4 py-2">2. fyzické osoby uplatňujúce svoje práva ako dotknuté osoby</td>
                    <td className="border border-gray-300 px-4 py-2">
                  ...
                  <tr>
                    <td className="border border-gray-300 px-4 py-2">3. Strany sporu, účastníci konania a ďalšie zúčastnené osoby</td>
                    <td className="border border-gray-300 px-4 py-2">
                    ...
                    <td className="border border-gray-300 px-4 py-2">súdy, exekútori, advokáti a iné orgány verejnej správy a subjekty, ktorým Prevádzkovateľ poskytuje OÚ na základe zákona, odborní konzultanti a poradcovia ktorí sú viazaní zákonnou a/alebo zmluvnou povinnosťou mlčanlivosti</td>
                  </tr>
                </tbody>
              </table>
            </div>
          ...
          <section>
            ...
            <p>
              <strong>Kategória OÚ, ktoré nemá prevádzkovateľ priamo od dotknutej osoby:</strong> dátum a čas doručenia požiadavky a obsah a odpoveď na požiadavku doručenú prostredníctvom kontaktného formulára.
            </p>
          </section>
