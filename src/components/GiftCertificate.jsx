...
// Flak shape 1 – pink (used top-left and top-right)
const FlakPink = ({ className }) => (
  <svg viewBox="0 0 170.079 170.658" xmlns="http://www.w3.org/2000/svg" className={className}>
    <path
...
// Flak shape 2 – cream/beige (used bottom-right)
const FlakCream = ({ className }) => (
  <svg viewBox="0 0 170.079 186.77" xmlns="http://www.w3.org/2000/svg" className={className}>
    <path
