    ...
    <div className="relative w-full bg-white">
      <section className="py-12 md:py-20 container-custom max-w-xl mx-auto px-4 sm:px-6 relative text-center">
        <div className="bg-white card-glass border-2 border-neutral-300 rounded-[2rem] shadow-md p-8 sm:p-12 relative overflow-hidden" style={{ isolation: 'isolate' }}>
          <FlakPink className="absolute pointer-events-none" style={{ width: 185, top: 10, right: -20, opacity: 0.32, zIndex: -1, transform: 'rotate(20deg)' }} />
          <FlakCream className="absolute pointer-events-none" style={{ width: 170, bottom: 10, left: -15, opacity: 0.30, zIndex: -1, transform: 'rotate(-15deg)' }} />
