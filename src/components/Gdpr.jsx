  ...
  return (
    <div className="relative w-full bg-white">
      ...
      <div className="bg-white card-glass border-2 border-neutral-300 rounded-[2rem] shadow-md p-8 sm:p-12 md:p-16 relative overflow-hidden" style={{ isolation: 'isolate' }}>
        <FlakPink className="absolute pointer-events-none" style={{ width: 190, top: 10, right: -22, opacity: 0.35, zIndex: -1, transform: 'rotate(15deg)' }} />
        <FlakCream className="absolute pointer-events-none" style={{ width: 175, bottom: 10, left: '30%', opacity: 0.32, zIndex: -1, transform: 'rotate(-20deg)' }} />
