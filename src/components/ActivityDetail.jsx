  ...
  return (
    ...
    <section className="min-h-screen py-12 md:py-16">
      <div className="container-custom max-w-4xl mx-auto">
        ...
        <article className="bg-white card-glass border-2 border-neutral-300 rounded-[2rem] shadow-md overflow-hidden relative" style={{ isolation: 'isolate' }}>
    <FlakPink className="absolute pointer-events-none" style={{ width: 210, top: 10, right: -30, opacity: 0.35, zIndex: -1, transform: 'rotate(20deg)' }} />
    <FlakCream className="absolute pointer-events-none" style={{ width: 190, top: '40%', left: -25, opacity: 0.32, zIndex: -1, transform: 'rotate(-25deg)' }} />
    <FlakPink className="absolute pointer-events-none" style={{ width: 180, bottom: 10, left: '35%', opacity: 0.30, zIndex: -1, transform: 'rotate(45deg)' }} />
          {/* Header */}
          ...
          <div className="p-8 sm:p-10 bg-neutral-50/50">
            <div className="max-w-xl mx-auto">
              ...
              {dates.length === 0 && (
                  <div className="text-center py-8 bg-white border border-neutral-300 rounded-2xl p-6">
              ...
              {dates.length > 0 && (
                <div className="space-y-4">
                  {dates.map((session) => (
                    <div
                      key={session.id}
                      className="rounded-2xl border border-neutral-300 bg-white p-5 shadow-sm flex flex-col sm:flex-row items-center justify-between gap-4 transition-all hover:border-primary/50 hover:shadow-md"
                      style={{
                        borderLeftWidth: '5px',
