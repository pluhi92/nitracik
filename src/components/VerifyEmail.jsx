...
const VerifyEmail = () => {
  ...
  return (
    <div className="relative w-full min-h-screen bg-white">
      <div className="py-12 md:py-20 container-custom max-w-xl mx-auto px-4 sm:px-6 relative text-center">
      <div className="bg-white rounded-[2rem] shadow-md border-2 border-neutral-300 p-8 sm:p-12 relative overflow-hidden">
        <FlakCream className="absolute pointer-events-none z-0" style={{ width: 180, top: 10, left: -18, opacity: 0.32, transform: 'rotate(-10deg)' }} />
        <FlakPink className="absolute pointer-events-none z-0" style={{ width: 170, bottom: 10, right: -15, opacity: 0.35, transform: 'rotate(25deg)' }} />
