...
const FLAKE_LAYOUTS = [
  { pink: { width: 150, top: 0, right: 0, transform: 'rotate(20deg)' }, cream: { width: 140, bottom: 0, left: 0, transform: 'rotate(-20deg)' } },
  { pink: { width: 150, bottom: 0, left: 0, transform: 'rotate(-15deg)' }, cream: { width: 140, top: 0, right: 0, transform: 'rotate(15deg)' } },
  { pink: { width: 150, top: 0, left: 0, transform: 'rotate(-25deg)' }, cream: { width: 140, bottom: 0, right: 0, transform: 'rotate(25deg)' } },
  { pink: { width: 150, bottom: 0, right: 0, transform: 'rotate(30deg)' }, cream: { width: 140, top: 0, left: 0, transform: 'rotate(-30deg)' } }
];
      ...
      <div className="min-h-[60vh] flex flex-col items-center justify-center bg-white gap-6 px-4">
        <div className="flex flex-col items-center gap-3">
          ...
          <p className="text-sm font-bold text-neutral-400 uppercase tracking-[0.15em]">
            {t?.activities?.loading || 'Načítavam aktivity...'}
          </p>
        </div>
      </div>
    );
  ...
  if (error) {
    return (
      <section className="min-h-[60vh] flex items-center justify-center px-4">
        <div className="text-center bg-white card-glass border-2 border-neutral-300 rounded-[2rem] p-8 shadow-md max-w-md w-full relative overflow-hidden" style={{ isolation: 'isolate' }}>
    <FlakCream className="absolute pointer-events-none" style={{ width: 160, top: 5, right: -20, opacity: 0.32, zIndex: -1, transform: 'rotate(20deg)' }} />
    <FlakPink className="absolute pointer-events-none" style={{ width: 140, bottom: 5, left: -15, opacity: 0.30, zIndex: -1, transform: 'rotate(-15deg)' }} />
  ...
  return (
    ...
    <section className="min-h-screen py-12 md:py-16">
      <div className="container-custom max-w-5xl mx-auto">
        {/* Header Banner */}
        <div className="mb-10 rounded-[2rem] card-glass border-2 border-neutral-300 bg-white p-6 sm:p-10 shadow-md relative overflow-hidden" style={{ isolation: 'isolate' }}>
    <FlakPink className="absolute pointer-events-none md:hidden" style={{ width: 150, top: 0, right: 0, opacity: 0.30, zIndex: -1, transform: 'rotate(20deg)' }} />
    <FlakCream className="absolute pointer-events-none md:hidden" style={{ width: 140, bottom: 0, left: 0, opacity: 0.30, zIndex: -1, transform: 'rotate(-20deg)' }} />
    <FlakPink className="absolute pointer-events-none hidden md:block" style={{ width: 210, top: 10, right: -30, opacity: 0.35, zIndex: -1, transform: 'rotate(20deg)' }} />
    <FlakCream className="absolute pointer-events-none hidden md:block" style={{ width: 190, top: '40%', left: -25, opacity: 0.32, zIndex: -1, transform: 'rotate(-25deg)' }} />
    <FlakPink className="absolute pointer-events-none hidden md:block" style={{ width: 180, bottom: 10, left: '35%', opacity: 0.30, zIndex: -1, transform: 'rotate(45deg)' }} />
        ...
        <div className="space-y-6">
          {types.length === 0 && (
            <div className="rounded-[2rem] border border-neutral-300 bg-white p-8 text-center text-neutral-500 font-medium">
          ...
          {types.map((type) => {
            ...
            const flakeLayout = FLAKE_LAYOUTS[(type.id || 0) % FLAKE_LAYOUTS.length];
                        ...
                        <div className="w-full max-w-xl mx-auto">
                          ...
                          <div className="space-y-3">
                            {typeDates.map((session) => (
                              <div
                                key={session.id}
                                className="rounded-2xl border border-neutral-300 bg-white p-4 sm:p-5 shadow-sm flex flex-col sm:flex-row items-center justify-between gap-4 transition-all hover:border-primary/50 hover:shadow-md"
                                style={{
                                  borderLeftWidth: '4px',
