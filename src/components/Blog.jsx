...
const Blog = ({ limit = null, showViewAll = true }) => {
  ...
  return (
    ...
    <section className="py-6 md:py-8 container-custom max-w-6xl mx-auto px-1 sm:px-6">
      ...
      {posts.length === 0 ? (
        <div className="text-center py-16 bg-white card-glass border-2 border-neutral-300 rounded-[2rem] shadow-md relative overflow-hidden" style={{ isolation: 'isolate' }}>
          <FlakPink className="absolute pointer-events-none" style={{ width: 180, top: 10, left: '30%', opacity: 0.30, zIndex: -1, transform: 'rotate(-15deg)' }} />
