...
const Checklist = () => {
    ...
    return (
        ...
        <section className="py-12 md:py-16 container-custom max-w-7xl mx-auto px-4 sm:px-6 relative">
            <div className="bg-white card-glass border-2 border-neutral-300 rounded-[2rem] shadow-md p-6 sm:p-10 relative overflow-hidden" style={{ isolation: 'isolate' }}>
                <FlakCream className="absolute pointer-events-none" style={{ width: 200, top: 10, left: '40%', opacity: 0.28, zIndex: -1, transform: 'rotate(-25deg)' }} />
                <FlakPink className="absolute pointer-events-none" style={{ width: 175, bottom: 10, right: -20, opacity: 0.30, zIndex: -1, transform: 'rotate(30deg)' }} />
