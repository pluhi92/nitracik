...
const NotFound = () => {
  ...
  return (
    <div className="relative w-full bg-white">
      <section className="py-12 md:py-20 container-custom max-w-2xl mx-auto px-4 sm:px-6 relative min-h-[70vh] flex flex-col justify-center">
        {/* Hlavná karta */}
        <div className="bg-white card-glass border-2 border-neutral-300 rounded-[2rem] shadow-md overflow-hidden p-8 sm:p-12 text-center relative" style={{ isolation: 'isolate' }}>
          <FlakPink className="absolute pointer-events-none" style={{ width: 185, top: 10, left: -20, opacity: 0.32, zIndex: -1, transform: 'rotate(-20deg)' }} />
          <FlakCream className="absolute pointer-events-none" style={{ width: 170, top: '45%', right: -15, opacity: 0.30, zIndex: -1, transform: 'rotate(30deg)' }} />
          <FlakPink className="absolute pointer-events-none" style={{ width: 160, bottom: 10, left: '40%', opacity: 0.28, zIndex: -1, transform: 'rotate(45deg)' }} />
