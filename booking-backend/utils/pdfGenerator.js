...
<head>
  ...
  <style>
    ...
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    /* Outer wrapper clips the decorative blobs at card boundary */
    .card-outer {
      position: relative;
      width: 842px;
      height: 595px;
...
<body>
  <div class="card-outer">
    <!-- Flak decorations — inside .card-outer so overflow:hidden clips them correctly -->
    <svg class="blob blob-top-left" viewBox="0 0 170.079 170.658" xmlns="http://www.w3.org/2000/svg">
      <path transform="matrix(1,0,0,-1,102.0004,33.3618)" fill="#F4A5A5" d="${flakPinkPath}"/>
    </svg>
    <svg class="blob blob-top-right" viewBox="0 0 170.079 170.658" xmlns="http://www.w3.org/2000/svg">
      <path transform="matrix(1,0,0,-1,102.0004,33.3618)" fill="#F4A5A5" d="${flakPinkPath}"/>
    </svg>
    <svg class="blob blob-bottom-right" viewBox="0 0 170.079 186.77" xmlns="http://www.w3.org/2000/svg">
      <path transform="matrix(1,0,0,-1,48.2144,165.57071)" fill="#EFE4C8" d="${flakCreamPath}"/>
    </svg>
